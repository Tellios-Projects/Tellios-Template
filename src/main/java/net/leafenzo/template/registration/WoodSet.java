...
import net.leafenzo.template.entity.ModBoatEntity;
import net.leafenzo.template.entity.ModEntityTypes;
import net.leafenzo.template.item.custom.ModBoatItem;
...
import static net.leafenzo.template.registration.ModRegistryHelper.*;
